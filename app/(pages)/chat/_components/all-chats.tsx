...
//         {Object.values(SearchImg).map((item) => (
//           <Link href={`/chat/${item.id}`} key={item.id}   onClick={() => setActiveItem(item.id)} 
//           className={`px-3 py-3 hover:bg-smoke-mmm w-full ${activeItem === item.id ? 'bg-[#eff8fc]' : ''}`}>
//             <div 
