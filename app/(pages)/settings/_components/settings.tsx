...
const SettingsPage = () => {
  ...
  return (
    <div className="md:py-6 py-4   bg-[#ffffff]">
      {/* Header Section */}
      <div className="flex items-center justify-between px-6 border-b pb-4">
        <h1 className="text-2xl font-bold text-gray-800">Settings</h1>
        <Button className="md:px-6 md:py-6 border border-red-500 text-red-500 mx-2 bg-white hover:bg-red-500 hover:text-white">
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              <p>
                ...
                the grounds that you hadn<code>&apos;</code>t previously agreed to us providing
                it.
              </p>
              <p>
          ...
          <AccordionItem value="item-5">
            ...
            <AccordionContent>
              ...
              <div className="py-2">
                <Button className="py-6 px-6 bg-[#f6b781]">Request sent</Button>
              </div>
          ...
          <AccordionItem value="item-6">
            ...
            <AccordionContent>
              <p>
                ...
                whether it<code>&apos;</code>s based on your consent or our legitimate interests.
                You also have the option to opt-out of our use of your personal
                information that we<code>&apos;</code>ve either made available or disclosed to
                third parties for advertising purposes. To unsubscribe from
                email notifications or adjust their frequency, head to the{" "}
                <span className=" text-lg font-semibold text-[#104482]">
                  {" "}
                  Email Notifications
                </span>{" "}
          ...
          <AccordionItem value="item-7">
            ...
            <AccordionContent>
              <div className="py-2">
                <p>
                  You can delete personal information we<code>&apos;</code>ve collected from you.
                </p>
              </div>
              <div className="py-2">
