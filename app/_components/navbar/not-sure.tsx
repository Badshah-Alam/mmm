          ...
          <div className="text-center mt-6 w-full px-4">
            <DialogFooter>
              <DialogClose asChild>
                <button
                  onClick={handleSave}
                  className="bg-orange-500 w-full text-white font-bold py-2 rounded-md"
                >
                  Save
                </button>
              </DialogClose>
...
//             <BsFillQuestionCircleFill className="text-4xl text-[#aeadb3] cursor-pointer" />
//           )}
//           <p className="text-base font-semibold hidden lg:block text-[#5e6266]">{currentName}</p>
//         </div>

//       </DialogTrigger>
//       <DialogContent className="sm:max-w-[425px]">
//         <div className="py-6">
//           <p className="text-center font-medium text-lg mb-4">Today I’m up for</p>
//           <div className="grid grid-cols-3 gap-4 px-6">
//             {notSureData.map((item) => (
//               <div
//                 key={item.id}
